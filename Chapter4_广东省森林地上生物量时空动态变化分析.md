...
<h3 style="text-align:left;">4.3 与现有森林地上生物量产品比较</h3>

<p align="left">
为进一步验证本研究森林AGB反演结果的精度与可靠性，选取了三个具代表性且空间覆盖广东省的现有 AGB 数据集进行对比分析，分别为：Yang 等人发布的全国 2019 年 30m 分辨率 AGB 产品、欧空局（ESA）提供的 100m 分辨率全球 AGB 产品，以及 Cai 等人的 CFATD 长时序 30m 分辨率中国 AGB 产品。
</p>
